...
int main() {
	...
	vector <string> name_files = {//CAMBIA SECONDO NECESSITà
		"corrected_ferm_obs3314513751.txt",
		"corrected_ferm_obs1615200272.txt",
		"corrected_ferm_obs2602939787.txt",
		"corrected_ferm_obs3624614669.txt",
		"corrected_ferm_obs4125601828.txt",
		"corrected_ferm_obs3379062322.txt",
		"corrected_ferm_obs3725763671.txt",
		"corrected_ferm_obs3825919538.txt",
		"corrected_ferm_obs1709664641.txt",
		"corrected_ferm_obs3812052727.txt",
		"corrected_ferm_obs920250475.txt",
		"corrected_ferm_obs1375234971.txt",
		"corrected_ferm_obs637002155.txt",
		"corrected_ferm_obs1229215857.txt",
		"corrected_ferm_obs3483143181.txt",
		"corrected_ferm_obs3946243793.txt",
		"corrected_ferm_obs443817478.txt",
		"corrected_ferm_obs1917658109.txt",
		"corrected_ferm_obs4237028932.txt",
		"corrected_ferm_obs2847033391.txt",
		"corrected_ferm_obs133777317.txt"
	};
